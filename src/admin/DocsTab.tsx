    ...
    <div className="space-y-6">
      ...
      <Block title="1. Как устроено хранение данных (низкоуровневые компоненты)">
        <ul className="list-disc space-y-2 pl-5">
          <li>«База данных» сайта — таблицы <Code>users</Code>, <Code>services</Code>, <Code>orders</Code>, <Code>events</Code>, <Code>posts</Code>, <Code>content</Code> в localStorage браузера (ключ <Code>probalance-db-v4</Code>). Сессия входа — в sessionStorage.</li>
      ...
      <Block title="2. Работа с низкоуровневыми компонентами (памятка)">
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li><b>Отладка:</b> в консоли браузера база доступна как <Code>JSON.parse(localStorage.getItem('probalance-db-v4'))</Code>.</li>
