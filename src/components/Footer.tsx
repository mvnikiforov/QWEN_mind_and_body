  ...
  return (
    <footer className="relative overflow-hidden bg-ink text-card">
      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-10 pt-14 sm:px-8 sm:pt-16">
        <p className="word-outline font-display font-medium uppercase leading-tight tracking-[0.12em] text-card/45 text-[clamp(24px,5vw,58px)]" aria-label="Тело, чувства, разум, дух — к балансу и ясности">
